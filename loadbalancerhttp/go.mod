module github.com/open-telemetry/opentelemetry-collector-contrib/exporter/loadbalancinghttp

go 1.18

require (
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchpersignal v0.62.0
...
require (
	...
	go.opentelemetry.io/collector/exporter/otlphttpexporter v0.63.0 // indirect
