...
RUN go get go.opentelemetry.io/collector/internal/obsreportconfig/obsmetrics@v0.48.0
RUN go get go.opentelemetry.io/collector/component@v0.48.0
...
RUN go install go.opentelemetry.io/collector/cmd/builder@v0.48.0
